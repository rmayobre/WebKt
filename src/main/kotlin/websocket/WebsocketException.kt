 ...
 */
sealed class WebsocketException : Exception {
...
class InvalidFrameException: WebsocketException {
    constructor() : super("Invalid OpCode found in websocket.frame.", ClosureCode.POLICY_VALIDATION)
...
/**
 * Client is required to Mask each fragment of the websocket.frame, if specified.
 */
 ...
 * @see <a href="https://tools.ietf.org/html/rfc6455#section-4">RFC 6455, Section 4 Opening websocket.Handshake</a>
...
class NoUTFException(exception: UnsupportedEncodingException):
    WebsocketException("Text websocket.frame did not support UTF-8 character set.", exception, ClosureCode.NO_UTF8)
