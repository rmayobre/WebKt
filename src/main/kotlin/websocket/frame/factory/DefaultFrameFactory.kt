...
class DefaultFrameFactory(
    /** Apply mask to each websocket.frame? */
    private val applyMask: Boolean,
    /** Byte limit for each websocket.frame before it requires fragmentation. */
    ...
    companion object {
        ...
        /** Build the final websocket.frame. */
        ...
        /** Build a continuation websocket.frame. */
        ...
        /** Build a fragmented websocket.frame. */
